...
extension Node {
  ...
  public static func optgroup(name: QualifiedName = "optgroup", attributes: Attributes = [:], children: [Node] = []) -> Node {
    return OptionGroupElement(name: name, attributes: attributes, children: children)
  }
